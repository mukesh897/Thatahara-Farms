<template>
  <footer class="max-w-screen-xl px-0 mx-auto">
    <section id="footer" class="footer py-4 bg-main">
   ...
   <div class="row-auto">
      <div class="w-full flex justify-center mb-4">
         ...
         <a href="https://www.facebook.com/profile.php?id=100094323992196&mibextid=LQQJ4d"> <span class="social-icon social-facebook">
