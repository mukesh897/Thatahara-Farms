      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        ...
        >
          <div class="sm:hidden xl:block mb-6 sm:mb-0">
            <a href="#">
              <img :src="require('~/assets/img/getting-started/logo-no-background.svg')" class="w-24 -mt-2" alt="Nefa Logo" />
            </a>
          </div>
          <ul class="space-y-4">
            <NavLink name="Properties" url="#" />
            <NavLink name="Farms" url="#" />
            <NavLink name="Estates" url="#" />
            <NavLink name="Land" url="#" />
            <NavLink name="Plot" url="#" />
          </ul>
        </div>
        <div
