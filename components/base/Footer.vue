<template>
  <footer class="max-w-screen-xl px-0 mx-auto">
    <section id="footer" class="footer py-4 bg-[#d4e8ce]">

    <div class="container">
      <div class="row-auto" id="contact">
          <h2 class="heading font-[Cenzil] text-center text-dark">Contact </h2>
          <p class="text-center font-[Raleway] leading-normal tracking-normal text-[18px]">We are excited to serve you. Let's connect!</p>
      </div>
      <div class="row-auto">
   ...
   <div class="row py-3 border-top  text-center pb-4">
      ...
      <div class="col-md-3 col-12">
         <div class="f-details">
            ...
            <p class="font-[Raleway]"> sales@thataharrafarms.com</p>
         </div>
      </div>
      <div class="col-md-3 col-12">
         <div class="f-details ">
            <h5 class="pb-3 heading font-[Cenzil]">Phone</h5>
            <p class="font-[Raleway]">9035354801/ 9035354802</p>
   ...
   <div class="row-auto">
      <div class="w-full flex justify-center mb-4">
         ...
         <a href="https://www.facebook.com/profile.php?id=61554287369102"> <span class="social-icon social-facebook">
         ...
         <a href="">
            <span class="social-icon social-youtube" style="background-color:red">
         ...
         <a href="https://wa.me/919606781033">
            <span class="social-icon social-whatsapp" style="background-color:#25D366">
         ...
         <a href="https://instagram.com/peacefarms2023?igshid=M2RkZGJiMzhjOQ%3D%3D&utm_source=qr">
      ...
      <div class="py-8 sm:py-4 text-center text-sm text-[#666666] hover:text-gray-900">
        &copy; Copyright 2023 THATAHARA Farms LLC. All rights reserved
      </div>
   </div>
