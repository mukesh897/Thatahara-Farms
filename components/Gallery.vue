    ...
    data() {
      return {
        ...
        images: [
            ...
            { link: require('~/assets/img/new/3.JPG'), caption: 'Image 3' },
            ...
            { link: require('~/assets/img/new/10.JPG'), caption: 'Image 10' },
            ...
            { link: require('~/assets/img/new/14.JPG'), caption: 'Image 14' },
